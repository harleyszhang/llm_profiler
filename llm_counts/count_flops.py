...
class CountCausalLMFlops(object):
    ...
    def __init__(self, model_config: ModelConfig, bs: int, seq_len: int, tp_size:int, simp_count=False) -> None:
    ...
    def count_flops_per_layer(self, bs: int, seq_len: int, ln_ignore=True) -> tuple:
        ...
        flops_per_layer_attention_kernel = self.count_flops_per_layer_attn_kernel(bs, seq_len)
    ...
    def count_flops_positional_embedding(self,) -> int:
